...
<main>
    ...
    <div class="content-box">
        <p class="intro"><h3>Cette fonctionnalité est en cours de développement</h3></p>
        <div class="advice-box">
            <p class="before">Veuillez contacter un administrateur pour prendre un rendez-vous dans nos laboratoires</p>
            <p class="after">Veuillez nous excuser pour la gêne occasionnée.</p>
        </div>
    </div>
</main>
