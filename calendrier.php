...
<header>
    ...
    <table border="3" >
        ...
        <tr>
            <td>9h 20</td>
            <?php
            if ($L2 == -1) { echo " <td class='RemplirCase'> Indisponible</td>"; } else if ($L2 ==$_SESSION['id']){ echo " <td class='maResa'><a href='annulationRdv.php?medecin=$IDMedecin&creneau=Lundi1'</a>Votre Rdv</td>";} else if ($L2 >=1) { echo "<td class='RemplirCase'>    Pris   </td>"; } else { echo "<td class='RemplirCaseLibre'> <a href='validationRdv.php?medecin=$IDMedecin&creneau=Lundi2'</a> Prendre RDV</td>"; }
