...
<script src="accueil.js" defer></script>
    ...
    <body>
        ...
        <main>
            <h1>Dépistage COVID-19</h1>
            <div class="content-box">
                <p class="intro"><h3>Le dépistage COVID-19 est crucial pour contrôler la propagation du virus. Assurez-vous de ne pas manger ni boire 30 minutes avant le test.</h3></p>
                <div class="advice-box">
                    <p class="before">Avant le test, restez hydraté et évitez les boissons contenant de la caféine. Portez un masque et maintenez la distanciation sociale au centre de dépistage.</p>
                    <p class="after">Après le test, continuez à observer les mesures de prévention recommandées jusqu'à l'obtention des résultats. En cas de test positif, suivez les directives de quarantaine.</p>
                </div>
